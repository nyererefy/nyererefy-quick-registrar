        ...
        while (($line = fgetcsv($csvFile)) !== FALSE):
            ...
            if ($nux->num_rows() > 0) {
                $data = [
                    ...
                    'index_no' => password_hash(strtoupper(preg_replace('/[^A-Za-z0-9]/', '', $line[2])), PASSWORD_BCRYPT, ['cost' => 4]),
                    'password' => password_hash(preg_replace('/[^A-Za-z0-9]/', '', $line[3]), PASSWORD_BCRYPT, ['cost' => 5]),
